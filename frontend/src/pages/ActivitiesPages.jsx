...
const events = [
  { title: "Farewell Party",         description: "A memorable farewell celebration for seniors with fun games, performances, and heartfelt goodbyes.", imageUrl: "/images/farewell.jpg" },
  { title: "Ganesh Chaturthi",       description: "Celebration of Ganesh Chaturthi with decoration, rituals, and vibrant community activities.",        imageUrl: "/images/ganesh.jpg" },
  { title: "Inchargeship Transfer",  description: "Passing on responsibilities to new hostel incharges in a fun and ceremonious occasion.",              imageUrl: "/images/inchargeship.jpg" },
  { title: "26 January Celebration", description: "Flag hoisting and patriotic events to honor Republic Day with pride and enthusiasm.",                 imageUrl: "/images/26january.jpg" },
  { title: "Janmashtami",            description: "Dahi Handi and cultural events to celebrate Krishna Janmashtami with joy and devotion.",              imageUrl: "/images/janmashtami.jpg" },
  { title: "Freshers Party",         description: "Welcome party for freshers with music, dance, games, and a warm community reception.",                imageUrl: "/images/freshers.jpg" },
  { title: "Christmas Celebration",  description: "Christmas party with decorations, gift exchange, carols, and festive cheer for all.",                 imageUrl: "/images/christmas.jpg" },
];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans">
      ...
      <div className="relative bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 px-10 pt-16 pb-14 overflow-hidden">
        ...
        <div className="absolute top-6 right-48 w-36 h-36 rounded-full border border-white/[0.06] pointer-events-none" />
        <div className="absolute -bottom-20 -left-12 w-56 h-56 rounded-full border border-white/[0.07] bg-white/[0.03] pointer-events-none" />
        ...
        <div className="max-w-3xl mx-auto relative z-10">
          ...
          <div className={`inline-flex items-center gap-2 bg-white/[0.07] border border-white/10 rounded-full px-4 py-1.5 mb-6 transition-all duration-700 ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
            ...
            <span className="text-white/70 text-[11px] font-bold tracking-[0.1em] uppercase">Campus Life</span>
          </div>
